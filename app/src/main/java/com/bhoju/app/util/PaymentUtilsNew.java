...
public class PaymentUtilsNew {
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        if (DIRECT_TOKENIZATION_PARAMETERS.isEmpty()
                ...
                || DIRECT_TOKENIZATION_PUBLIC_KEY.equals("REPLACE_ME")) {
    ...
    private static JSONObject getMerchantInfo() throws JSONException {
        return new JSONObject().put("merchantName", "CodeGama");
    }
    ...
    public static Optional<JSONObject> getPaymentDataRequest(long priceCents) {
        ...
        final String price = PaymentUtilsNew.centsToString(priceCents);

        try {
            JSONObject paymentDataRequest = PaymentUtilsNew.getBaseRequest();
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(PaymentUtilsNew.getCardPaymentMethod()));
            paymentDataRequest.put("transactionInfo", PaymentUtilsNew.getTransactionInfo(price));
            paymentDataRequest.put("merchantInfo", PaymentUtilsNew.getMerchantInfo());
